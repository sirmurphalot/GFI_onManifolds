        ...
        for j=(i+1):d
            ...
            for l=1:(d-1)
                ...
                if(l~=(d-1))
                    count2 = count2 + 1;
                    %%% Calculate partial 
                    dc(count2, countA) = (cov_mat(1,l)*cov_d_A_ij(1,l+1) - ...
                        cov_mat(1,l+1)*cov_d_A_ij(1,l))/((cov_mat(1,l))^2) - ...
                        (cov_mat(1,l+1)*cov_d_A_ij(1,l+2) - cov_mat(1,l+2)*cov_d_A_ij(1,l+1))/...
                        ((cov_mat(1,l+1))^2);
                end
    ...
    for i=1:d
        ...
        for l=1:(d-1)
            ...
            if(l~=(d-1))
                count2 = count2 + 1;
                %%% Calculate partial 
                dc(count2, countLambda) = (cov_mat(1,l)*cov_d_Lambda_ii(1,l+1) - ...
                    cov_mat(1,l+1)*cov_d_Lambda_ii(1,l))/((cov_mat(1,l))^2) - ...
                    (cov_mat(1,l+1)*cov_d_Lambda_ii(1,l+2) - cov_mat(1,l+2)*cov_d_Lambda_ii(1,l+1))/...
                    ((cov_mat(1,l+1))^2);
            end
